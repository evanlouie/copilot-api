...
may include loadable `function`/`namespace` specs; those returned specs are
accepted for transcript continuity, but they become callable only after a later
request supplies an installed tool catalog.
