...
const goldenSparseUsageRecordJSON = `{"version":3,"id":"resp_sparse_usage","sdk_session_id":"","model":"","created_at":"2026-07-25T18:56:00Z","updated_at":"2026-07-25T18:57:30Z","status":"completed","stored":true,"deleted":false,"output":null,"output_text":"","usage":{"input_tokens":0,"input_tokens_details":{"cache_write_tokens":0,"cached_tokens":0},"output_tokens":12,"output_tokens_details":{"reasoning_tokens":0},"total_tokens":12}}`
...
func goldenResponseRecord() ResponseRecord {
	...
	return ResponseRecord{
		...
		Usage: &openai.ResponseUsage{
			InputTokens:         11,
			InputTokensDetails:  openai.ResponseInputTokensDetails{CacheWriteTokens: 5, CachedTokens: 3},
			OutputTokens:        7,
